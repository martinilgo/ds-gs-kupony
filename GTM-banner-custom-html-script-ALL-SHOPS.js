  ...
  fetch(JSON_URL + '?t=' + Date.now())
    ...
    .then(function(banners){
      ...
      css.appendChild(document.createTextNode(
        '#promoBanner{position:absolute;top:0;left:0;right:0;color:' + textColor + ';padding:6px 24px;text-align:center;font-size:' + fontSize + ';z-index:999999;font-family:' + fontFamily + ';border-radius:' + borderRadius + ';animation:promoBannerSlide .4s ease-out;display:flex;align-items:center;justify-content:center;gap:5px;border:0 !important;box-shadow:none !important;border-bottom:0 !important;border-bottom-width:0 !important;border-bottom-style:none !important;border-bottom-color:transparent !important;}' +
